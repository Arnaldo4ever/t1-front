                    ...
                    <Form method="post" className="mt-3">
                        <div className="grid grid-cols-12 gap-4 md:gap-8">
                            ...
                            <div className="col-span-12 md:col-span-5 order-1 md:order-4">
                                ...
                                <div className="w-full py-5 px-8 sticky top-0 right-0 left-0 bg-white rounded-lg mt-5">
                                    <div className="grid grid-cols-12 gap-4">
                                        <div className="col-span-12">
                                            <div className="flex flex-col space-y-5">
                                                <div className="relative">
                                                    <div className="flex items-center justify-start space-x-2">
                                                        <p className="font-sans font-bold text-base text-slate-900">Datos extraídos de Shopify</p>
                                                    </div>
                                                </div>
                                                <p className="font-sans font-medium text-xs text-gray-900">- Nombre: Andres</p>
                                                <p className="font-sans font-medium text-xs text-gray-900">- Apellido: Gutierrez</p>
                                                <p className="font-sans font-medium text-xs text-gray-900">- Correo: andres.4ever@gmail.com</p>
                                                <p className="font-sans font-medium text-xs text-gray-900">- Teléfono: 313 444 0041</p>
                                                <p className="font-sans font-medium text-xs text-gray-900">- Dirección: Cra. 8 No. 9 - 83, Bogotá, D.C</p>
                                                <p className="font-sans font-medium text-xs text-gray-900">- Provincia: La Candelaria</p>
                                                <p className="font-sans font-medium text-xs text-gray-900">- Código Postal: 111711</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
