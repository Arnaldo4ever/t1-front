                                ...
                                <div className="col-span-12">
                                    <div className="flex flex-col items-center justify-center align-middle h-full">
                                        <div className="max-w-full md:max-w-4xl flex flex-col items-center justify-center bg-green-50 rounded-md shadow-xl py-10 px-5 md:px-10 text-center">
                                            {/* <h1 className="font-sans text-3xl font-bold text-[#202020]">T1Pagos</h1> */}
                                            ...
                                            {/* <p className="font-sans text-lg font-medium text-[#202020] leading-normal">Su pedido ha sido aprobado exitosamente.</p> */}
                                            ...
                                            <Link to="/" prefetch="render" relative="route" className="font-sans text-base mt-7 md:mt-10 text-white bg-[#202020] hover:bg-slate-700 py-3.5 md:py-3 px-5 rounded-md transition-all">Volver a Comprar</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
